...
<p data-importer="text" align="left">Sou desenvolvedor backend Java em formação, atualmente focado em consolidar lógica de programação, orientação a objetos e boas práticas de código.<br><br>Estudo diariamente e compartilho aqui minha evolução, exercícios e projetos práticos.<br><br>Meu objetivo é atuar como desenvolvedor backend até dezembro de 2026.</p>
